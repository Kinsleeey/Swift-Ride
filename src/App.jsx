    ...
    <div className="app">
        ...
        <div className={`screen ${currentScreen === "s1" ? "active" : ""}`} id="s1">
            ...
            <div className="choice-grid">
                <HomeOption addClass="accent-card" click={() => go('s2-ride')} image="/src/assets/undraw_on-the-way_zwi3 (1).svg" mainText="I need a ride" subText="Go anywhere, anytime" />
                <HomeOption click={() => go('s2-errand')} image="/src/assets/undraw_empty_4zx0 (1).svg" mainText="Run an errand" subText="Pick up, deliver, buy" />
            </div>
